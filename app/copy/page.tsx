...
import DropDown2, { FormatType } from '../../components/DropDown2';
...
export default function Page() {
  ...
  const [format, setFormat] = useState<FormatType>('Texto');
    ...
    <div className="flex max-w-5xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-12 sm:mt-20">
        ...
        <h1 className="sm:text-4xl text-2xl max-w-[708px] font-bold text-slate-900">
          Notas Copy - Genera textos rápido
        </h1>
        <p className="text-slate-500 mt-5">Selecciona un estilo y genera en segundos.</p>
        <form className="max-w-xl w-full" onSubmit={onSubmit}>
          ...
          <textarea
            ...
            placeholder={
              'Cómo hacerse viral en TikTok con esta estratégia'
            }
          />
          <div className="flex mb-5 items-center space-x-3">
            <Image src="/2-black.png" width={30} height={30} alt="1 icon" />
            <p className="text-left font-medium">Selecciona un estilo.</p>
          </div>
          <div className="block">
          ...
          <div className="flex mt-10 mb-5 items-center space-x-3">
            ...
            <p className="text-left font-medium">Selecciona un formato.</p>
          </div>
          <div className="block">
            <DropDown2 format={format} setFormat={(newFormat) => setFormat(newFormat)} />
          </div>
